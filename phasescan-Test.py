...
from leastsq import ScanDataFit
...
class FitThread(CAThread):
    ...
    def run(self):
        data_fit = ScanDataFit(self.payload)
        rfPhase, energy_gain, amp, e, x_plot, y_plot = data_fit.single_bpm_fit()
...
class MyFrame(wx.Frame):
    ...
    def set_magnets(self, fname):
        mebt_pvs = []
        hebt_pvs = []
        cm_pvs = []

        with open(fname) as lattice:
            pass
